function PrivacyPolicy (props) {
    ...
    <h4>Last updated September 17, 2022</h4>



    <p>This privacy notice for Crypto G's ("Company," "we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
    Visit our website at http://www.cryptogs.com, or any website of ours that links to this privacy notice
    Download and use our mobile application (crypto g's), or any other application of ours that links to this privacy notice
    ...
    Want to learn more about what Crypto G's does with any information we collect? Click here to review the notice in full.
    </p>
    ...
    <p>In Short: In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.
    ...
    Crypto G's has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Crypto G's will not sell personal information in the future belonging to website visitors, users, and other consumers.
    ...
    <p>If you have questions or comments about this notice, you may email us at __________ or by post to:
